...
static void test_confuse_stream_compression_simple_compress_decompress() {
    const char test_str[] = "aaaaaaabbbbbbbccccccctesttesttest";
    grpc_slice_buffer source, relay, sink;
    grpc_slice_buffer_init(&source);
    grpc_slice_buffer_init(&relay);
    ...
    grpc_stream_compression_context* compress_ctx =
            grpc_stream_compression_context_create(
                    GRPC_STREAM_COMPRESSION_CONFUSE_COMPRESS);
    grpc_stream_compression_context* decompress_ctx =
            grpc_stream_compression_context_create(
...
static void
test_confuse_stream_compression_simple_compress_decompress_with_output_size_constraint() {
    const char test_str[] = "aaaaaaabbbbbbbccccccctesttesttest";
    grpc_slice_buffer source, relay, sink;
    grpc_slice_buffer_init(&source);
    grpc_slice_buffer_init(&relay);
...
static void
test_confuse_stream_compression_simple_compress_decompress_with_large_data() {
    char* test_str =
            static_cast<char*>(gpr_malloc(LARGE_DATA_SIZE * sizeof(char)));
    generate_random_payload(test_str, LARGE_DATA_SIZE);
    grpc_slice_buffer source, relay, sink;
...
static void test_confuse_stream_compression_drop_context() {
    const char test_str[] = "aaaaaaabbbbbbbccccccc";
    const char test_str2[] = "dddddddeeeeeeefffffffggggg";
    grpc_slice_buffer source, relay, sink;
    grpc_slice_buffer_init(&source);
...
static void test_confuse_stream_compression_sync_flush() {
    const char test_str[] = "aaaaaaabbbbbbbccccccc";
    const char test_str2[] = "dddddddeeeeeeefffffffggggg";
    grpc_slice_buffer source, relay, sink;
    grpc_slice_buffer_init(&source);
...
int main(int argc, char** argv) {
  ...
  test_confuse_stream_compression_simple_compress_decompress();
  test_confuse_stream_compression_simple_compress_decompress_with_output_size_constraint();
  test_confuse_stream_compression_simple_compress_decompress_with_large_data();
  test_confuse_stream_compression_sync_flush();
  //test_confuse_stream_compression_drop_context();
