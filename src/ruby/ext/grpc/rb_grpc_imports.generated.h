...
typedef void(*grpc_compression_register_compressor_type)(grpc_message_compressor_vtable *vtable);
extern grpc_compression_register_compressor_type grpc_compression_register_compressor_import;
#define grpc_compression_register_compressor grpc_compression_register_compressor_import
typedef const grpc_message_compressor_vtable *(*grpc_compression_compressor_type)(const grpc_slice *compressor_name);
extern grpc_compression_compressor_type grpc_compression_compressor_import;
#define grpc_compression_compressor grpc_compression_compressor_import
typedef void(*grpc_stream_compression_register_compressor_type)(grpc_stream_compressor_vtable *vtable);
extern grpc_stream_compression_register_compressor_type grpc_stream_compression_register_compressor_import;
#define grpc_stream_compression_register_compressor grpc_stream_compression_register_compressor_import
typedef const grpc_stream_compressor_vtable *(*grpc_stream_compression_compressor_type)(const grpc_slice *compressor_name);
extern grpc_stream_compression_compressor_type grpc_stream_compression_compressor_import;
#define grpc_stream_compression_compressor grpc_stream_compression_compressor_import
